...
::
  ...
  curl https://raw.github.com/clevertechru/travis-solr/master/travis-solr.sh | SOLR_VERSION=3.6.1 SOLR_CONFS=schema.xml solrconfig.xml SOLR_DOCS=custom_docs.json bash
...
line to your .travis.yml: ::
  ...
  before_script: curl https://raw.github.com/clevertechru/travis-solr/master/travis-solr.sh | SOLR_VERSION=3.6.1 bash
